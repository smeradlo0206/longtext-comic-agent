...
| EvidenceRefV1 | Source traceability pointer. | chunk_id | Optional range/quote | All story agents | All story agents | CommitService validates |
...
| EventProposalV1 | Candidate event. | proposal_id, type, summary, evidence_refs, confidence | Required | Temporal/state agents | Event agent | CommitService later |
