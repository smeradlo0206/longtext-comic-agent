...
class StoryBibleCurator:
    ...
    _SYSTEM_PROMPT = (
        ...
        "(entity_proposals, event_proposals, claim_proposals, "
        "state_change_proposals), the timeline agent's "
        ...
        "with name, statement, and optional scope. You may also promote a "
        "claim_proposal into a world rule only when it is a narrator-level factual "
        "assertion about the setting itself (subject is the world, a location, or "
        "an organization) — never a character's belief, prediction, or opinion.\n"
