...
as 应该, 恐怕, 可能, 或许, 也许, 似乎, 大概, 估计, 我想, probably, perhaps, or seems.
BELIEF: an explicit, non-tentative mental stance such as 认为, 相信, 坚信, 以为, or
认定. When an explicit belief also contains a real uncertainty hedge, use HYPOTHESIS.
EVALUATION: a subjective assessment of quality, strength, difficulty, value, or
desirability, such as 惊人, 强大, 弱小, 困难, 容易, 优秀, or 糟糕. Do not use it for
...
“我会向武家讨还这笔债” -> COMMITMENT, not PREDICTION.
